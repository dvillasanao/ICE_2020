...
<a href="/images/Localidad/ICE%20a%20nivel%20localidad.png" data-lightbox="image-1" data-title="ICE_mun">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%', fig.cap="Elaboración propia"}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/images/Localidad/ICE a nivel localidad.png"))
```
</a>