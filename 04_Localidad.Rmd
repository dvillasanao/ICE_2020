...
```{r, echo = FALSE, out.width = '70%', fig.align='center', eval = FALSE}
...
<a href="/Output/Localidad/pcr_model_denue_CrossValidation_Page_05.png" data-lightbox="image-15" data-title="pcr_denue">
```{r, echo=FALSE, out.width='70%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Localidad/pcr_model_denue_CrossValidation_Page_05.png"))
```
</a>
...
```{r, echo = FALSE, fig.width=10,  out.width = '100%', eval = FALSE}
caret.pcr <- readRDS(paste0(here::here(), "/Output/Localidad/caret_pcr_denue_cv.rds"))
load(paste0(here::here(), "/Bases/Subsistemas_DENUE.Rdata"))
tablas <- names(Subsitemas)

## Se guardan las tablas en un excel 
wb <- createWorkbook()
for(i in 1:11){
addWorksheet(wb, paste(tablas[i]))
writeData(wb, i, caret.pcr[[i]][["results"]])
saveWorkbook(wb, 
              file = paste0(here::here(),"/Output/Localidad/caret_pcr_denue_cv.xlsx"), 
               overwrite = TRUE)
}
...
<a href="/Output/Localidad/caret_pcr_denue_CrossValidation_Page_05.png" data-lightbox="image-16" data-title="caret_pcr_denue">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Localidad/caret_pcr_denue_CrossValidation_Page_05.png"))
```
</a>
...
```{r, echo = FALSE, eval = FALSE}
saveRDS(PCA_SEP, file = paste0(here::here(), "/Output/Localidad/PCA_SEP.RDS"))
```
...
```{r, echo = FALSE}
PCA_SEP <- readRDS(file = paste0(here::here(), "/Output/Localidad/PCA_SEP.RDS"))

tabla <- facto_summarize(PCA_SEP, "var", axes = 1:4) %>%
           as.data.frame() %>%
            rename("Indicadores" = "name")
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Localidad/PCR_SEP.RData"))
...
pcr_extremos %>% 
 as.data.frame() %>%
  mutate_at(vars(2:3), as.numeric) %>%
   gt() %>%
    tab_header(title = "Tabla: Valores extremos utilizando Principal Component Regression (PCR)",  
               subtitle = "Indicadores de la SEP a nivel localidad") %>%
     tab_options(heading.title.font.size = 14, 
                 heading.subtitle.font.size = 12,
                 table.font.names = "Century Gothic",
                 table.font.size = 10,
...
```{r, echo = FALSE, out.width = '70%', fig.align='center', eval = FALSE}
pcr_model <- readRDS(paste0(here::here(), "/Output/Localidad/pcr_model_sep_cv.rds"))
       ...
       ggplot(aes(x = ncomp)) +
        geom_line(aes(y = CV, color = "line1")) + 
         geom_line(aes(y = adjCV, color = "line2"), linetype = "dashed") + 
          geom_point(aes(y = CV, color = "line1")) + 
           geom_point(aes(y = adjCV, color = "line2")) + 
            geom_text_repel(aes(y = CV, label = format(CV, scientific = TRUE, digits = 2), color = "line1"),
                                color = "#767676", 
                                size = 2.5, 
                                force = 0.5,
                                force_pull = 0, 
               ...
               theme_minimal() +
                ...
                scale_color_manual(labels = c("CV", "CVAdj"), 
                 ...
                 scale_x_continuous(breaks = seq(0, 10, by = 1)) +
                  labs(title = "Validation Plot", 
                       subtitle = "Subsitema de educación",
                       x = "Number of Components", 
                       y = "Mean Squared Error of Prediction (MSEP)",
                       color = "CrossValidation") 
p
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Localidad/pcr_model_sep_CrossValidation.pdf"),
         width =  10,
         height = 8,
         device = "cairo_pdf")
```
...
<a href="/Output/Localidad/pcr_model_sep_CrossValidation.png" data-lightbox="image-17" data-title="pcr_sep">
```{r, echo=FALSE, out.width='70%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Localidad/pcr_model_sep_CrossValidation.png"))
```
</a>
...
```{r, echo = FALSE, fig.width=10,  out.width = '100%', eval = FALSE}
caret.pcr <- readRDS(paste0(here::here(), "/Output/Localidad/caret_pcr_sep_cv.rds"))

# Extraer los datos de validación
validation_data <- caret.pcr[["results"]]

write.xlsx(validation_data, paste0(here::here(), "/Output/Localidad/caret_pcr_sep_cv.xlsx"), overwrite = TRUE)
             ...
             scale_color_viridis_d(option = "A", begin = 0, end = 0.8) +
              scale_y_continuous(labels = scales::unit_format(scale = 1e-1, unit = NULL)) + 
               scale_x_continuous(breaks = seq(0, 10, by = 1)) + 
                facet_wrap(. ~ variable, scales = "free") + 
                 labs(title = "Validation Plot",
                      subtitle = "Subsistema de educación",
                      x = "Number of Components", 
                      y = "",
                      color = "CrossValidation") 
p
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Localidad/caret_pcr_sep_CrossValidation.pdf"),
         width =  15,
         height = 8,
         device = "cairo_pdf")
```

<a href="/Output/Localidad/caret_pcr_sep_CrossValidation.png" data-lightbox="image-18" data-title="caret_pcr_sep">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Localidad/caret_pcr_sep_CrossValidation.png"))
```
</a>
...
```{r, echo = FALSE, eval = FALSE}
saveRDS(PCA_CLUES, file = paste0(here::here(), "/Output/Localidad/PCA_CLUES.RDS"))
```
...
```{r, echo = FALSE}
PCA_CLUES <- readRDS(file = paste0(here::here(), "/Output/Localidad/PCA_CLUES.RDS"))

tabla <- facto_summarize(PCA_CLUES, "var", axes = 1:2) %>%
          rename("Indicadores" = "name") %>%
           as.data.frame()
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Localidad/PCR_CLUES.RData"))
...
pcr_extremos %>% 
 as.data.frame() %>%
  mutate_at(vars(2:3), as.numeric) %>%
   gt() %>%
    tab_header(title = "Tabla: Valores extremos utilizando Principal Component Regression (PCR)",  
               subtitle = "Indicadores del CLUES a nivel localidad") %>%
     tab_options(heading.title.font.size = 14, 
                 heading.subtitle.font.size = 12,
                 table.font.names = "Century Gothic",
                 table.font.size = 10,
...
```{r, echo = FALSE, out.width = '70%', fig.align='center', eval = FALSE}
pcr_model <- readRDS(paste0(here::here(), "/Output/Localidad/pcr_model_clues_cv.rds"))
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Localidad/pcr_model_clues_CrossValidation.pdf"),
         width =  10,
         height = 8,
         device = "cairo_pdf")
```

<a href="/Output/Localidad/pcr_model_clues_CrossValidation.png" data-lightbox="image-19" data-title="pcr_clues">
```{r, echo=FALSE, out.width='70%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Localidad/pcr_model_clues_CrossValidation.png"))
```
</a>
...
```{r, echo = FALSE, fig.width=10,  out.width = '100%', eval = FALSE}
caret.pcr<- readRDS(paste0(here::here(), "/Output/Localidad/caret_pcr_clues_cv.rds"))
# Extraer los datos de validación
validation_data <- caret.pcr[["results"]]

write.xlsx(validation_data, paste0(here::here(), "/Output/Localidad/caret_pcr_clues_cv.xlsx"), overwrite = TRUE)
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Localidad/caret_pcr_clues_CrossValidation.pdf"),
         width =  15,
         height = 8,
         device = "cairo_pdf")
```
...
<a href="/Output/Localidad/caret_pcr_clues_CrossValidation.png" data-lightbox="image-20" data-title="caret_pcr_clues">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Localidad/caret_pcr_clues_CrossValidation.png"))
```
</a>
...
```{r, echo = FALSE, fig.height=3, fig.width=7, eval = FALSE}
p <- ICE_2020 %>%
      ggplot() + 
       geom_boxplot(aes(x = ICE, y = "", color = ICE), fill = "transparent", size = 0.3) + 
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Localidad/boxplot_ICE.pdf"),
         width =  6,
         height = 4,
         device = "cairo_pdf")
```
...
<a href="/Output/Localidad/boxplot_ICE.png" data-lightbox="image-22" data-title="Boxplot_Loc_ICE">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/Output/Localidad/boxplot_ICE.png"))
```
</a>
...
<div class = "col-md-8">
```{r, echo = FALSE, out.width = "80%", out.height= "80%", eval = FALSE}
rows <- c(nrow(sd))
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Localidad/min_strata_ICE.pdf"),
         width =  6,
         height = 6,
         device = "cairo_pdf")
```
...
<a href="/Output/Localidad/min_strata_ICE.png" data-lightbox="image-23" data-title="min_strata_Loc_ICE">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/Output/Localidad/min_strata_ICE.png"))
```
</a>
...
<a href="/images/Localidad/ICE_Loc_Mapa.png" data-lightbox="image-24" data-title="ICE_Loc_Mapa">
