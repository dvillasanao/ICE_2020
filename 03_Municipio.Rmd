     ...
     tab_style(style = list(cell_text(align = "left", 
      ...
      tab_style(style = list(cell_text(align = "left")),
       ...
       cols_label(CVE_MUN = md("**Clave del municipio**"),
                  ...
                  PL.5000 = md("**Porcentaje de ocupantes en viviendas con piso de tierra**"),
...
<a href="images/IAL a nivel municipal_ggridges.png" data-lightbox="image-1" data-title="IAL_municipio">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/images/IAL a nivel municipal_ggridges.png"))
```
</a>
