...
**Se tienen todas las observaciones** 
...
pcr_model <- readRDS(paste0(here::here(), "/Output/Municipio/pcr_model_denue_cv.rds"))
require(ggrepel)
...
require(ggpubr)
ggexport(plotlist = p, 
         filename =paste0(here::here(), "/Output/Municipio/pcr_model_denue_CrossValidation.pdf"),
          width =  10,
         height = 8,
         device = "cairo_pdf")
```
...
<a href="/Output/Municipio/pcr_model_denue_CrossValidation_Page_05.png" data-lightbox="image-5" data-title="pcr_denue">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Municipio/pcr_model_denue_CrossValidation_Page_05.png"))
```
</a>
...
caret.pcr <- readRDS(paste0(here::here(), "/Output/Municipio/caret_pcr_denue_cv.rds"))
...
saveWorkbook(wb, 
              file = paste0(here::here(), "/Output/Municipio/caret_pcr_denue_cv.xlsx"), 
               overwrite = TRUE)
}
...
require(ggpubr)
ggexport(plotlist = p, 
         filename =paste0(here::here(), "/Output/Municipio/caret_pcr_denue_CrossValidation.pdf"),
         width =  15,
         height = 8,
         device = "cairo_pdf")
```
...
<a href="/Output/Municipio//caret_pcr_denue_CrossValidation_Page_05.png" data-lightbox="image-6" data-title="caret_pcr_denue">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Municipio//caret_pcr_denue_CrossValidation_Page_05.png"))
```
</a>
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Municipio/pcr_model_sep_CrossValidation.pdf"),
         width =  10,
         height = 8,
         device = "cairo_pdf")
```
...
<a href="/Output/Municipio/pcr_model_sep_CrossValidation.png" data-lightbox="image-7" data-title="pcr_sep">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Municipio/pcr_model_sep_CrossValidation.png"))
```
</a>
...
write.xlsx(validation_data, paste0(here::here(), "/Output/Municipio/caret_pcr_sep_cv.xlsx"), overwrite = TRUE)
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Municipio/caret_pcr_sep_CrossValidation.pdf"),
         width =  15,
         height = 8,
         device = "cairo_pdf")
```
...
<a href="/Output/Municipio/caret_pcr_sep_CrossValidation.png" data-lightbox="image-9" data-title="caret_pcr_sep">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Municipio/caret_pcr_sep_CrossValidation.png"))
```
</a>
...
```{r, echo = FALSE, out.width = '70%', fig.align='center', eval = FALSE}
pcr_model <- readRDS(paste0(here::here(), "/Output/Municipio/pcr_model_clues_cv.rds"))
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Municipio/pcr_model_clues_CrossValidation.pdf"),
         width =  10,
         height = 8,
         device = "cairo_pdf")
```
...
<a href="/Output/Municipio/pcr_model_clues_CrossValidation.png" data-lightbox="image-11" data-title="pcr_clues">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Municipio/pcr_model_clues_CrossValidation.png"))
```
</a>
...
```{r, echo = FALSE, fig.width=10,  out.width = '100%', eval = FALSE}
caret.pcr<- readRDS(paste0(here::here(), "/Output/Municipio/caret_pcr_clues_cv.rds"))
summary(caret.pcr)
# Extraer los datos de validación
validation_data <- caret.pcr[["results"]]

write.xlsx(validation_data, paste0(here::here(), "/Output/Municipio/caret_pcr_clues_cv.xlsx"))
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Municipio/caret_pcr_clues_CrossValidation.pdf"),
         width =  15,
         height = 8,
         device = "cairo_pdf")
```
...
<a href="/Output/Municipio/caret_pcr_clues_CrossValidation.png" data-lightbox="image-12" data-title="caret_pcr_clues">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics(paste0(here::here(), "/Output/Municipio/caret_pcr_clues_CrossValidation.png"))
```
</a>
...
```{r, echo = FALSE}
require(psych)
tabla <- psych::describe(accesibilidad_mun$IAL) 
...
<a href="/images/Municipio/IAL a nivel municipal_ggridges.png" data-lightbox="image-13" data-title="IAL_municipio">
...
p <- ICE_2020 %>%
      ggplot() + 
       geom_boxplot(aes(x = ICE, y = "", color = ICE), fill = "transparent", size = 0.5) + 
        geom_jitter(aes(x = ICE, y = "", color = ICE, fill = ICE), size = 0.5, alpha = 0.3) + 
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Municipio/boxplot_ICE.pdf"),
         width =  6,
         height = 4,
         device = "cairo_pdf")
```
...
<a href="/Output/Municipio/boxplot_ICE.png" data-lightbox="image-14" data-title="Boxplot_Mun_ICE">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/Output/Municipio/boxplot_ICE.png"))
```
</a>
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/Municipio/min_strata_ICE.pdf"),
         width =  6,
         height = 6,
         device = "cairo_pdf")
```
...
<a href="/Output/Municipio/min_strata_ICE.png" data-lightbox="image-15" data-title="min_strata_Mun_ICE">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/Output/Municipio/min_strata_ICE.png"))
```
</a>
...
<a href="/images/Municipio/ICE_Mun_Mapa.png" data-lightbox="image-16" data-title="ICE_Mun_Mapa">
