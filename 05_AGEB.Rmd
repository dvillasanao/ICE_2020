        ...
        geom_line(data = tabla %>% filter(Indicadora == ""), aes(x = n, y = PC, color = "LINE1"), size = 2, alpha = 0.5) + 
         ...
         theme_ipsum_es(grid="X") +
           theme(title = element_text(size = 15, family = "Century Gothic"),
                  plot.title = element_text(size = 14, family = "Century Gothic"),
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/AGEB/pcr_ageb_eu.pdf"),
         width =  8,
         height = 5,
         device = "cairo_pdf")
```
...
<a href="/Output/AGEB/pcr_ageb_eu.png" data-lightbox="image-25" data-title="pcr_ageb_eu">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/Output/AGEB/pcr_ageb_eu.png"))
```
</a>
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/AGEB/boxplot_ICE.pdf"),
         width =  6,
         height = 4,
         device = "cairo_pdf")
```
...
<a href="/Output/AGEB/boxplot_ICE.png" data-lightbox="image-26" data-title="Boxplot_AGEB_ICE">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/Output/AGEB/boxplot_ICE.png"))
```
</a>
...
require(ggpubr)
ggexport(p, 
         filename =paste0(here::here(), "/Output/AGEB/min_strata_ICE.pdf"),
         width =  6,
         height = 6,
         device = "cairo_pdf")
```
...
<a href="/Output/AGEB/min_strata_ICE.png" data-lightbox="image-27" data-title="min_strata_AGEB_ICE">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/Output/AGEB/min_strata_ICE.png"))
```
</a>
