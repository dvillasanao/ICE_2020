...
require(knitr)
knitr::include_graphics(paste0(here::here(), "/images/Metodología ICE.png"))
```
</a>
...
Por lo tanto, la proporción de la varianza explicada del kkk-ésimo componente principal está dada por:   
