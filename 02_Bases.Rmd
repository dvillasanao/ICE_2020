...
<a href="img/IE_Subsectores.png" data-lightbox="image-1" data-title="Subsectores">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/img/IE_Subsectores.png"))
```
</a>
...
<a href="img/IAL a nivel municipal_Mapa.png" data-lightbox="image-1" data-title="IALmun">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/img/IAL a nivel municipal_Mapa.png"))
```
</a>
...
<a href="img/IAL a nivel localidad_Mapa.png" data-lightbox="image-1" data-title="IALloc">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/img/IAL a nivel localidad_Mapa.png"))
```
</a>
...
<center>
![](img/Ocampo_Mun.png){#id .class width=450 height=300px}
</center>
