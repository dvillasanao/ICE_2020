...
<a href="images/IAL a nivel municipal_Mapa.png" data-lightbox="image-1" data-title="IALmun">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/images/IAL a nivel municipal_Mapa.png"))
```
</a>
...
<a href="images/IAL a nivel localidad_Mapa.png" data-lightbox="image-1" data-title="IALloc">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/images/IAL a nivel localidad_Mapa.png"))
```
</a>
