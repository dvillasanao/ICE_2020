...
<a href="/images/Municipio/IAL a nivel municipal_Mapa.png" data-lightbox="image-1" data-title="IALmun">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/images/Municipio/IAL a nivel municipal_Mapa.png"))
```
</a>
...
<a href="/images/Localidad/IAL a nivel localidad_Mapa.png" data-lightbox="image-1" data-title="IALloc">
```{r, echo = FALSE, fig.width=12, fig.height=12, out.width='100%'}
require(knitr)
knitr::include_graphics(paste0(here::here(), "/images/Localidad/IAL a nivel localidad_Mapa.png"))
```
</a>
